...
const MintMakeMote = () => {
	return (
		<div className='flex flex-col place-items-center'>
			<div className='bg-zinc-200 rounded-xl max-w-[800px]'>
				...
				<h2 className='font-inter p-2 text-center text-xl'>
					Then you can go flex on your friends in the metaverse with the
					craziest movements you’ve ever seen! Play in the verse freely, save
					your moves to compete in battle and keep earning, or sell on the open
					market and make some more!
				</h2>
