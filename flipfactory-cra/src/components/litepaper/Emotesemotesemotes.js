	...
	return (
		<div>
			...
			<div className='text-xs font-light'>
				...
				<br />
				<br />
				These movements have always been limited to a few choices and without
				much variety. In the coming metaverses, people will want options. They
				will want to be able to differentiate their character’s movements from
				everyone else. In order to do that we will need a lot of options and
				ways to call on them quickly.
				<br />
				<br />
				...
				the Flip Factory comes in. These movements have always been limited to a
				few choices and without much variety. In the coming metaverses, people
				will want options. They will want to be able to differentiate their
				character’s movements from everyone else. In order to do that we will
				need a lot of options and ways to call on them quickly.
				<br />
				<br />
				Luckily, many of these virtual worlds are building functionality like
				this into their core for people like us to build on top of, and, “if we
